...
RUN mkdir -p /usr/src/geonode_bioresilmed
...
COPY src /usr/src/geonode_bioresilmed/
WORKDIR /usr/src/geonode_bioresilmed
...
RUN chmod +x /usr/src/geonode_bioresilmed/tasks.py \
    && chmod +x /usr/src/geonode_bioresilmed/entrypoint.sh
...
# ENTRYPOINT /usr/src/geonode_bioresilmed/entrypoint.sh
