...
try:
    from geonode_bioresilmed.local_settings import *
except ImportError:
    from geonode_bioresilmed.settings import *
...
def _reset():
    ...
    sh(f"rm -rf {path}")
    sh("rm -rf geonode_bioresilmed/development.db")
    sh("rm -rf geonode_bioresilmed/uploaded/*")
    _configure_data_dir()
