...
echo "-----------------------------------------------------"
echo "STARTING geonode_bioresilmed RESTORE $(date)"
echo "-----------------------------------------------------"
...
cd /usr/src/geonode_bioresilmed/
...
SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./geonode_bioresilmed/br/backup.sh $BKP_FOLDER_NAME/$NEW_UUID
...
echo "-----------------------------------------------------"
echo " - Original Backup of $TARGET_URL --> /$BKP_FOLDER_NAME/$NEW_UUID/"
echo "FINISHED geonode_bioresilmed RESTORE $(date)"
echo "-----------------------------------------------------"
